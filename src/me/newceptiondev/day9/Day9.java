...
public class Day9 {
    ...
    public static final String fileName = "day9Task1Input";
    ...
    public Day9(final List<String> inputs) {
    ...
    private Tuple<Long, Long> findTermsOfSum(final Long sum, final Set<Long> possibleTerms) {
        ...
        for (Long summand : possibleTerms) {
            ...
            if (!summand.equals(neededSecondSummand) && possibleTerms.contains(
                    neededSecondSummand)) {
