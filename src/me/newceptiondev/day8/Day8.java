...
public class Day8 {
    ...
    public static final String fileName = "day8Task1Input";
     ...
     * @return Tuple of Accumulator and Boolean
     * True if Set of Instructions was successfully executed
     * False if there would have been a duplicated Execution
     */
    ...
    /**
     * Modifies the Set of Instructions and returns the Result of the Run with the modified Instructions
     *
     ...
     * False if there would have been a duplicated Execution
     */
    private Tuple<Integer, Boolean> switchInstructionAndRun(List<Instruction> instructions, Integer switchIndex, Operation newOperation) {
